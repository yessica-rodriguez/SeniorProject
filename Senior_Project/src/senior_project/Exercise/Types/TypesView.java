 ...
 * @author yessi
 */
public class TypesView extends VBox{
    private Label w = new Label();
    private HBox heading = new HBox(); 
    private HBox list = new HBox();
    private Button b = new Button("View Exercise Types List");
