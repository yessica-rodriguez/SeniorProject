...
public class Diseases {
    ...
    String state = "SELECT * FROM seniorproject.disease WHERE ID = '";
    ...
    public Diseases(int numDis, String name, String description) {
        this.numDis = numDis;
        this.name = name;
    ...
    public int getNumDis() {
        numDis = 0;
        try (PreparedStatement statement = connection.prepareStatement("SELECT * FROM seniorproject.disease"))
        {
