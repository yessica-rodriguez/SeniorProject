...
INSERT INTO `users` VALUES (1,'SuperM','krypton',1,4,3,'cape','fly','plane'),(2,'WonderW','Sword',2,0,8,'Amazon','WWI','Steve'),(3,'Batman','damian',2,5,8,'bat','black','bad'),(4,'SpiderMan','spidey',1,4,7,'Queens','Midtown','Oscorb');
